...
<body class="container">
    ...
    <!-- <nav class="navbar navbar-expand-lg navbar-light bg-dark container-fluid">
       ...
       <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="container register bg-secondary mt-5">
          <div class="row">
              <div class="col-md-3 register-left mt-5">
                 
                  <h3>Welcome</h3>
                  <p>Register your account here to access all our features..</p>
                  <b>xyz.mywebsite</b>
                      ...
                      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                          ...
                          <div class="row register-form mt-4">
                              ...
                              <div class="col-md-6">
                                  ...
                                  <div class="form-group">
                                      <input type="text" minlength="10" maxlength="10" name="txtPhone" class="form-control" required  placeholder="Your Phone *" value="" />
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      <input type="text" class="form-control" name="txtadd" required placeholder="Address *" value="" />
                                  </div>
