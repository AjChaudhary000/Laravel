      ...
      <div class="data mt-5">
       <?php
            ...
            if(isset($_GET['qno'],$_GET['sname']))
            {
                ...
                $qry = "select * from mcq_que where sub_name ='$t_id' and q_no ='$rq_no' ";
            ...
            else
            {
                ...
                $con=mysqli_connect("localhost","root","");
                mysqli_select_db($con,"q2");
                $qry = "select * from mcq_que where sub_name ='$t_id'";
                $result=mysqli_query($con,$qry);
                $lst=mysqli_fetch_array($result);
       ...
       <div class="row col-md-10">
           ...
           <p class="col-md-10"><?php echo $lst['question']; ?></p>
           <div class="col-md-1"><input type="hidden" name=subject value="<?php  $sub = $lst['sub_name'];  echo $sub; ?>" ></div>
          ...
          <div class="col-md-2 mt-5"  ><input class="btn-success form-control"  type=submit  id="myid" name=btnsave value="save"></div>
           ...
           <div class="col-md-2 mt-5">
               ...
               <a href="view_que.php?qno=<?php echo $no; ?>&sname=<?php echo $sub; ?>&next=1"><p class="btn-info form-control" onclick="savebtn()" id="nt" style="display: none;"  >Next Que</p></a>
     </div>
  ...
  <!-- code to display answer is wrong or write -->
    ...
    <div class="col-md-5"></div>
      ...
      if(isset($_GET['submit']))
      {
         ...
         <a href="userscore.php?submitans=<?php echo $subname; ?>"><h5 class="btn btn-success form-control col-md-12">Submit</h5></a>
    ...
    <div class="row col-md-12 mt-5">
     ...
     <?php 
        ...
        {
            header("location:userscore.php?score_user");
        }  
...
<script type="text/javascript">
   ...
   //    alert("clicked");
    ...
    //   }
       ...
       let hidenext = parameter.get("submit");
