<nav class="navbar navbar-expand-lg navbar-light bg-dark container-fluid">
      ...
      <b class="text-light">Question 3</b>
   </div>
     <div class="collapse navbar-collapse" id="navbarSupportedContent">
       <ul class="navbar-nav ml-auto mr-5 bg-warning">
         ...
         <li class="nav-item">
           <a class="nav-link " href="addpol.php">Add Pool</a>
         </li>
         <li class="nav-item">
           <a class="nav-link " href="poolstatus.php">Pool Status</a>
         </li>
         ...
         <?php
          ...
          <!-- <select class="form-control border border-rounded bg-success " name="" id="">
            <option value=""></option>
             <option value=""></option> -->
          <!-- </select> -->
             <h5 class=" ml-2 pt-2 fas fa-user-tie bg-dark text-light border  mt-1 mr-1"><?php echo $_SESSION['USER']; ?>.. </h5> 
        </li>
        <li>
            <!-- <form action="backend.php?lg">
